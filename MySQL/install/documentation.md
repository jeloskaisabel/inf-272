...
## Obtención del Instalador de MySQL Community Edition

## Acceso a la Página de Descargas
...
## Selección de la Versión y Sistema Operativo
...
Para este trabajo, hemos elegido la versión `8.0.36` y el sistema operativo Windows, debido a su estabilidad y por ser la opción más adecuada para un entorno de aprendizaje.
...
## Opciones de Descarga de MySQL Installer para Windows
...
1. Claro, aquí te presento una redacción mejorada para esa sección:
...
2. Antes de ejecutar el instalador, recomendamos encarecidamente verificar la suma de comprobación MD5 y la firma digital GnuPG para confirmar la integridad y autenticidad del paquete.

---

## Instalación de MySQL Community Edition

Después de obtener el instalador completo de MySQL:

### Iniciando el Instalador
1. Localice y ejecute el archivo `.msi` descargado para lanzar MySQL Installer, que es el programa de instalación y gestión para productos MySQL.
   ![alt text](image-9.png)

### Uso del MySQL Installer
2. Cuando MySQL Installer se inicie, se presentará con una interfaz que enumera los productos de MySQL que están listos para la instalación o que ya están instalados. En su caso, debería ver `MySQL Shell` como un producto ya listo.
![alt text](image-10.png)

3. La interfaz del instalador ofrece varias opciones para gestionar sus productos MySQL:
...
Entendido, aquí tienes una redacción más detallada para esa sección, explicando la selección de los componentes:

---

### Selección de Componentes

En la pantalla 'Select Products' (Seleccionar Productos) del MySQL Installer, deberá seleccionar los componentes que serán instalados. A continuación, se describen los componentes disponibles:
...
Para seleccionar estos componentes, siga estos pasos detallados:
...
Para nuestro propósito, hemos elegido 'MySQL Server 8.0.36 - X64' y 'MySQL Workbench 8.0.36 - X64', que son las últimas versiones disponibles en arquitectura de 64 bits, compatibles con nuestro equipo. La elección de estas versiones asegura que estamos utilizando las iteraciones más estables y seguras de estas herramientas fundamentales.
Tras seleccionar los productos y haga clic en 'Next'.

### Descarga de Componentes
![alt text](image-13.png)

La siguiente ventana 'Download' (Descarga) muestra los productos que han sido seleccionados para la instalación y están listos para ser descargados:
...
![ ](image-14.png)
Una vez que todos los componentes han sido descargados satisfactoriamente:

4. **Haga clic en 'Next'** (Siguiente) para proceder a la fase de instalación, donde el instalador instalará los productos descargados en su sistema.


Esta imagen muestra la ventana 'Product Configuration' del MySQL Installer, que indica que está listo para comenzar la configuración del 'MySQL Server 8.0.36'. Aquí está cómo podría redactar la explicación para esta parte:

### Configuración del Producto MySQL
...
3. Haga clic en 'Next' (Siguiente) para iniciar el asistente de configuración, que lo guiará a través de varios pasos para definir las configuraciones de su servidor MySQL. Esto incluirá la configuración de tipos de redes, cuentas de usuarios, seguridad del servidor y más.
![alt text](image-15.png)

---

### Configuración de Tipo de Servidor y Red en MySQL Server
![alt text](image-16.png)
En la etapa de 'Type and Networking' del MySQL Server 8.0.36, realizará ajustes esenciales que definirán el comportamiento del servidor y su interacción con la red:
...
### Elección del Método de Autenticación en MySQL Server
...
### Establecimiento de Cuentas y Roles en MySQL

Ahora se encuentra en la pantalla "Accounts and Roles":
...
- Use el botón **"Add User"** para crear cuentas adicionales de usuario, si es necesario para su aplicación o usuarios individuales.

Al completar esta configuración, haga clic en "Next" para avanzar al siguiente paso del proceso de instalación.

---

### Configuración del Servicio de Windows para MySQL
...
- **Cuenta del Sistema para Ejecutar el Servicio**:
   - Seleccione "Standard System Account" para que el servicio de MySQL opere bajo la cuenta del sistema estándar. Esta es la opción preferida para la mayoría de los escenarios, ya que ofrece un buen equilibrio entre seguridad y facilidad de uso sin la necesidad de gestionar permisos de usuario específicos.
...
### Configuración de Permisos de Archivos del Servidor
...
La imagen muestra la etapa final en el MySQL Installer, "Apply Configuration", donde aplicarás y confirmarás todas las configuraciones establecidas para tu servidor MySQL. Aquí tienes cómo proseguir:

---

### Aplicación de la Configuración del Servidor MySQL
...
La pantalla muestra que la configuración del producto MySQL Server 8.0.36 ha sido completada exitosamente.

---

### Confirmación de la Configuración del Producto

La configuración del 'MySQL Server 8.0.36' ha finalizado correctamente. Para finalizar el proceso de instalación, haga clic en **"Next"**.
...
Ahora está viendo la pantalla de inicio de MySQL Workbench, que es la herramienta gráfica de usuario (GUI) oficial para la gestión de bases de datos MySQL. 

---

### Página de Inicio de MySQL Workbench

A continuación visualizará la pantalla principal de MySQL Workbench, donde puede comenzar a administrar su base de datos:
